  ...
  var Picker = function (params) {
      ...
      p.updateValue = function () {
          ...
          if (p.input && p.input.length > 0) {
              ...
              /*改进：当picker有displayValue时，input里的value理应显示displayValue*/
              $(p.input).val(p.params.formatValue ? p.params.formatValue(p, p.value, p.displayValue) : p.displayValue ? p.displayValue.join(' ') : p.value.join(' '));
