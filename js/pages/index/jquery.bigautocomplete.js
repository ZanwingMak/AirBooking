(function($){
    var bigAutocomplete = new function(){
        ...
        this.autocomplete = function(param){
            ...
            //输入框促发事件
            $this.on('input propertychange keyup keydown',(function(event) {
                var k = event.keyCode;
                ...
                if(!isFunctionalKey && (!ctrl || (ctrl && k == 67) || (ctrl && k == 88)) ){
                    ...
                    if(data != null && $.isArray(data) ){
                        ...
                        for(var i=0;i<data.length;i++){
                            ...
                            if($.inArray(keyword_,country) >= 0){
                                if(data[i].country == keyword_){
                                    data_.push(data[i]);
                                }
                            }else if(data[i].name.toLowerCase().indexOf(keyword_.toLowerCase()) > -1){
                                data_.push(data[i]);
                            }
                        }
                        if(data_.length > 0){
